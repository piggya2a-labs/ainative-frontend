...
export function Hero({ siteConfig, agentCount = 0, toolCount = 0, onCtaClick, onDemoClick, onTemplatesClick }: HeroProps) {
  ...
  const subheadline = hero?.hero_subtitle || hero?.subheadline || 'Automate your day-to-day tasks like updating your CRM, scheduling meetings, and following up with leads. No coding required—just connect your tools and let AI agents handle the work.'
  ...
  const defaultTrustIndicators = [
    ...
    { icon: 'bot', text: 'Enterprise-Ready Context Memory' },
  ]
